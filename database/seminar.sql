...
(12, 'hjhhj', 'dssdsd', 2, '2835fbef241bdc94f3977b0d07d6ecfd.jpg');
...
(166, 1, 1, '2024-05-01', '00:37:23', 1, 1),
(167, 1, 1, '2024-05-01', '00:37:59', 1, 1),
(168, 1, 1, '2024-05-01', '00:39:17', 1, 1),
(169, 1, 1, '2024-05-01', '00:39:55', 1, 1),
(171, 2, 1, '2024-05-01', '00:46:25', 1, 1);
...
(82, 1, 12345678, 1, '2024-04-30', '10:21:29', 2);
...
(2, 'hhkjkkj', '2024-05-15', '2fc35a2c08550772461850b9526e7420.jpg');
...
(2, 'Nutragen', '503e56f7e0818aada74a6005adcb47de.jpg', 2),
...
(7, 'oke', 'b364692ef213572d69ab4739aa0ac79f.jpg', 1);
...
(5, 2, 343434, 555, '667111ae2d7b789b777290b2c817077c.jpg');
...
(1, '127.0.0.1', 'administrator', '$2y$12$ml83HGMMj9/8lQ9yTVmhrO/jIQiGPEwvn0cIXYRP2W3fIaUHeo7G.', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1714477385, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
ALTER TABLE `pembicara`
  MODIFY `id_pembicara` tinyint(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `pendaftaran_seminar`
--
ALTER TABLE `pendaftaran_seminar`
  MODIFY `id_pendaftaran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;

--
-- AUTO_INCREMENT for table `presensi_seminar`
--
ALTER TABLE `presensi_seminar`
  MODIFY `id_presensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `tiket`
  MODIFY `id_tiket` tinyint(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
